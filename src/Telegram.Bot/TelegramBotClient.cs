...
#pragma warning restore AsyncFixer03 // Avoid fire & forget async void methods
        ...
        public Task<Message> SetGameScoreAsync(int userId, int score, long chatId, int messageId, bool editMessage = false,
            CancellationToken cancellationToken = new CancellationToken())
            => SetGameScoreAsync(userId, score, chatId.ToString(), messageId, false, false, editMessage, cancellationToken);
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>On success, if the message was sent by the bot, returns the edited Message</returns>
        public Task<Message> SetGameScoreAsync(int userId, int score, long chatId, int messageId, bool force = false, bool disableEditMessage = false, bool editMessage = false,
            CancellationToken cancellationToken = default(CancellationToken))
            => SetGameScoreAsync(userId, score, chatId.ToString(), messageId, force, disableEditMessage, editMessage, cancellationToken);
        ...
        /// <returns>On success, if the message was sent by the bot, returns the edited Message</returns>
        [Obsolete("Use SetGameScoreAsync with force and disableEditMessage")]
        public Task<Message> SetGameScoreAsync(int userId, int score, string chatId, int messageId, bool editMessage = false,
            CancellationToken cancellationToken = new CancellationToken())
            => SetGameScoreAsync(userId, score, chatId, messageId, false, false, editMessage, cancellationToken);
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>On success, if the message was sent by the bot, returns the edited Message</returns>
        public Task<Message> SetGameScoreAsync(int userId, int score, string chatId, int messageId, bool force = false, bool disableEditMessage = false, bool editMessage = false,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            var parameters = new Dictionary<string, object>
            {
        ...
        /// <returns>On success, if the message was sent by the bot, returns the edited Message</returns>
        [Obsolete("Use SetGameScoreAsync with force and disableEditMessage")]
        public Task<Message> SetGameScoreAsync(int userId, int score, string inlineMessageId, bool editMessage = false,
            CancellationToken cancellationToken = new CancellationToken())
            => SetGameScoreAsync(userId, score, inlineMessageId, false, false, editMessage, cancellationToken);
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>On success, if the message was sent by the bot, returns the edited Message</returns>
        public Task<Message> SetGameScoreAsync(int userId, int score, string inlineMessageId, bool force, bool disableEditMessage, bool editMessage = false,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            var parameters = new Dictionary<string, object>
            {
        ...
        public Task<GameHighScore[]> GetGameHighScoresAsync(int userId, long chatId, int messageId,
                CancellationToken cancellationToken = new CancellationToken())
            => GetGameHighScoresAsync(userId, chatId.ToString(), messageId, cancellationToken);
        ...
        /// Will also return the top three users if the user and his neighbors are not among them. Please note that this behavior is subject to change.
        /// </remarks>
        public Task<GameHighScore[]> GetGameHighScoresAsync(int userId, string chatId, int messageId,
            CancellationToken cancellationToken = new CancellationToken())
        {
            var parameters = new Dictionary<string, object>
            {
        ...
        /// Will also return the top three users if the user and his neighbors are not among them. Please note that this behavior is subject to change.
        /// </remarks>
        public Task<GameHighScore[]> GetGameHighScoresAsync(int userId, string inlineMessageId, CancellationToken cancellationToken = new CancellationToken())
        {
            var parameters = new Dictionary<string, object>
            {
                {"user_id", userId},
        ...
        public Task<Message> SendGameAsync(long chatId, string gameShortName, bool disableNotification = false,
            ...
            =>
            SendGameAsync(chatId.ToString(), gameShortName, disableNotification, replyToMessageId, replyMarkup,
                     cancellationToken);
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>On success, the sent Message is returned.</returns>
        public Task<Message> SendGameAsync(string chatId, string gameShortName, bool disableNotification = false,
            int replyToMessageId = 0,
            IReplyMarkup replyMarkup = null, CancellationToken cancellationToken = new CancellationToken())
        ...
        public Task<Message> SendAudioAsync(long chatId, FileToSend audio, int duration, string performer, string title,
            ...
            =>
                SendAudioAsync(chatId.ToString(), audio, duration, performer, title, disableNotification,
                    replyToMessageId,
                    replyMarkup, cancellationToken, caption);
        ...
        public Task<Message> SendAudioAsync(string chatId, FileToSend audio, int duration, string performer, string title, string caption,
           bool disableNotification = false,
           int replyToMessageId = 0,
           IReplyMarkup replyMarkup = null)
        {
        ...
        public Task<bool> AnswerCallbackQueryAsync(string callbackQueryId, string text = null,
            ...
            string url = null,
            CancellationToken cancellationToken = default(CancellationToken))
            => AnswerCallbackQueryAsync(callbackQueryId, text, showAlert, url, 0, cancellationToken);
